...
class Model_conv(nn.Module):
    def __init__(self):
        ...
        self.backbone = timm.create_model(CFG.model_name, pretrained=True, num_classes=0, global_pool='', drop_rate=0.2, drop_path_rate=0.2)
    ...
    def forward(self, inp):
        ...
        features = self.drop_head(features)
...
#shutil.copy("./train1.ipynb", f"./test.ipynb")
